...
An important skill to learn is *debuggin\\\\\\*g. This is the process of
locating and removing errors from your code. When debugging, it's very useful
to be able to read and \\\\\\*understand* the error messages.
