...
So far the loops we have looked at have had simple blocks of code inside the
loop, i.e. the blocks that were being repeated were quite simple. What you'll
see is that the code inside the loop can be as complicated as you'd like. For
example, we can add conditionals inside the loop.
