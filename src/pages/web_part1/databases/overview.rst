...
A database stores data relating to a particular subject. For example, you can have a
database storing all the information on staff in a company.
...
- The **transactions** table tells us which customers have bought which items, and how
...
A query is an instruction that tells the database what to do. For example, we can get a
database to display a table, or we can tell the database to add new data.
...
(Structured Query Language). Like Python, SQL has its own rules for how you should write
commands.
