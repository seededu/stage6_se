...
A good programming practice is to make sure that your code is **readable** so that it is
easier for you and for other people to understand. It also makes it easier to identify
...
Sometimes you might want to add longer comments. In SQL we use ``/*`` to begin the
